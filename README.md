...
- сверка документов: <http://127.0.0.1:8765/>;
- карточка остатков: <http://127.0.0.1:8765/drawing-card>;
- сверка папки Excel (PDF АОСР — дополнительно): <http://127.0.0.1:8765/package-reconciliation>;
...
## Локальная сверка Excel с PDF

В панели есть и папочный вариант этой проверки: откройте
`http://127.0.0.1:8765/package-reconciliation`, выберите одну папку с Excel и
скачайте JSON-отчёт после завершения. PDF АОСР можно добавить дополнительно для
