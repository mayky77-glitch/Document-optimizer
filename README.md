...
Интегрированы **блоки 1–2 — «Каркас проекта, инвентаризация источников и
индексы документов»**.
...
- необязательные индекс, кандидаты, уверенность и предупреждения блока 2.
