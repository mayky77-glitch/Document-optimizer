...
- M03/M07/M08/M12 `+ value` matches the exact normalized base or any string beginning with it plus continuation; no separate Table-2 suffix comparison, hard excludes first. M08 aliases Table-2 «Укладка»/«Укладка трубопроводов» but only a Table-1 pipe-laying prefix in the same ГК object auto-matches; 18 observed 0918/0919/0685/0686 rows use `км`, while container/geomaterial laying stays out.
