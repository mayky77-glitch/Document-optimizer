...
- The values listed in [BUSINESS_RULES §7](../docs/BUSINESS_RULES.md) are blockers, not accepted defaults: M04/M05 exact include sets, M13/M14, suffix/supporting-work semantics, stage/month/whole-period/quantity, J/L blank behavior/rounding mode, automatic unit conversion, versions, formula freshness, feedback policy and AI context/token budget. Numeric two-decimal J/L comparison and prior coefficient/unit/review rules are accepted. [[components/document-reconciliation|Component card]]
