...
- The values listed in [BUSINESS_RULES §7](../docs/BUSINESS_RULES.md) are blockers, not accepted defaults: M04/M05 exact include sets, M13/M14, suffix/supporting-work semantics, stage/month/whole-period/quantity, J/L tolerance, automatic unit conversion, versions, formula freshness, feedback policy and AI context/token budget. The coefficient configuration/warning flow, no-process `0/0`, checkbox review and alternative-unit grouping are accepted. [[components/document-reconciliation|Component card]]
