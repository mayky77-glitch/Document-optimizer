...
Owner must approve: Table 1 sheet/whole-period semantics; M04 exact power include set and supporting works; M05 exact low-current include set; M13/M14 precedence; M03/M07/M08/M12 suffix semantics; stage/version selection; month/current-period semantics; quantity destination and new-column meaning; coefficient 2.7 basis; J/L equality/tolerance; automatic unit conversion; formula freshness/recalc; precision/overwrite; feedback reuse compatibility, retention, deactivate/rollback and user authority; AI context/token budget and storage/retrieval thresholds. Semantic unit comparison, red `old/source`, quantity priority/single-alternative/multiple-group behavior, cost from all approved rows, `0/0` for no process-name candidates and checkbox review are already fixed. M02/M06 literals are already fixed. Exit: signed decision record and fixtures updated. No implementation fallback is allowed.
