...
Owner must approve: feedback reuse compatibility, retention, deactivate/rollback and user authority; AI context/token budget and storage/retrieval thresholds. M04/M05 marker classification plus review-only wiring/support/auxiliary candidates, prefix semantics, M14/M13 ownership and prior rules are fixed. M02/M06 literals are fixed.
