...
- **Типы:** `WriteDecision`, `QualityIssueSeverity`, `QualityIssueCode`
...
- **Статус:** в работе; release evidence отсутствует.
...
- **Evidence:** tests/model smoke/clean install/PR/CI — **NOT RUN / не предоставлено**.
