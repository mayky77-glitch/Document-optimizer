...
ensure_index() {
  ...
  if qdrant_curl --fail --silent --show-error -X PUT "${headers[@]}" \
...
if qdrant_curl --fail --silent "${headers[@]}" \
  ...
  qdrant_curl --fail --silent --show-error -X PUT "${headers[@]}" \
...
qdrant_curl --fail --silent --show-error "${headers[@]}" \
